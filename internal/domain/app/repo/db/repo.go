...
func (r *Repo) List(ctx context.Context, pars *model.ListReq) ([]*model.App, int64, error) {
...
func (r *Repo) Get(ctx context.Context, id string) (*model.App, bool, error) {
	m := &repoModel.Select{
		PKId: id,
	}
...
func (r *Repo) Create(ctx context.Context, obj *model.App) (string, error) {
...
func (r *Repo) Update(ctx context.Context, id string, obj *model.App) error {
	m := repoModel.DecodeUpsert(obj)
	m.PKId = id
